...
function AION_LOOP_HTMS($source, $destiny, $destiny2) {
	...
	$grandmarker['BOOK_NT']		= $grandtotal['BOOK_NT']-12374;
	$grandmarker['CHAP_TOTAL']	= $grandtotal['CHAP_TOTAL']-358246;
	...
	$grandmarker['FIXED']		= $grandtotal['FIXED']-14700;
	...
	$grandmarker['PDFPA']		= $grandtotal['PDFPA']-261626;
	$grandmarker['PDFPN']		= $grandtotal['PDFPN']-60248;
	$grandmarker['PDFPI']		= (float)$grandtotal['PDFPI']-5980.52;

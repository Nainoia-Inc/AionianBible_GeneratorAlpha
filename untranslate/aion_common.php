...
function AION_LOOP_HTMS($source, $destiny, $destiny2) {
	...
	$grandmarker = array();
	$grandmarker['BIBLE_COUNT']	= $grandtotal['BIBLE_COUNT']-540;
	$grandmarker['LANG_COUNT']	= $grandtotal['LANG_COUNT']-280;
	$grandmarker['BOOK_OT']		= $grandtotal['BOOK_OT']-9950;
	$grandmarker['BOOK_NT']		= $grandtotal['BOOK_NT']-12401;
	$grandmarker['CHAP_TOTAL']	= $grandtotal['CHAP_TOTAL']-358506;
	$grandmarker['VERS_TOTAL']	= $grandtotal['VERS_TOTAL']-9614136;
	$grandmarker['VERS_AION']	= $grandtotal['VERS_AION']-108665;
	$grandmarker['VERS_QUES']	= $grandtotal['VERS_QUES']-487;
	$grandmarker['LONG']		= $grandtotal['LONG']-2542;
	...
	$grandmarker['FIXED']		= $grandtotal['FIXED']-14709;
	$grandmarker['NOTFIXED']	= $grandtotal['NOTFIXED']-60071;
	...
	$grandmarker['PDFPA']		= $grandtotal['PDFPA']-261898;
	$grandmarker['PDFPN']		= $grandtotal['PDFPN']-60248;
	$grandmarker['PDFPI']		= (float)$grandtotal['PDFPI']-5987.38;
	...
	$grandmarker['PDF_PLUL']	= $grandtotal['PDF_PLUL']-529;
	...
	$grandmarker['PDF_PRTL']	= $grandtotal['PDF_PRTL']-384;
	$grandmarker['TRANS']		= $grandtotal['TRANS']-475;
